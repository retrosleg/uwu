...
["Cheerer"] = {
	...
	["Accessory"] = {15368908193,108460810078507,131309695264210,13570493554,18319933084,89860179134457,94575969446253,18970087631,15433591037},
	["Clothes"] = {["Shirt"] = 8549932044, ["Pants"] = 1211469425},
	["TClothes"] = {["Shirt"] = 0, ["Pants"] = 0},
	["Clothing"] = {"Roblox Breasts Clothing","Roblox Shirt","Roblox Butt Shirt","Roblox Pants","Skirt 1","Pussy Closed"},
	["Preset"] = {Tone = "Dark", Face = false, BodyPartPhysics = true, PhysicsObeyGravity = true, PositionPhysicsMultiply = 1, RotationPhysicsMultiply = 5, BreastsScale = 1, ButtsScale = 1, LegsScale = 1, BreastsType = 1, TorsoType = 7, ArmType = 1, LegsType = 1, ButtType = 1, HardcoreHP = true, TopHP = 50, BottomHP = 50, DamageSFX = 0.1, Volume = 100.2},
	["Recolor"] = {["Skirt 1"] = {["Primary"] = Color3.fromRGB(232, 196, 208)}}
},
...
["Celestial"] = {
	...
	["Accessory"] = {14687177103,17313276701,17179937407,86729401701731,106831917513695,127747463230338,15341428879,120970041600349,15341428879},
	["Clothes"] = {["Shirt"] = 16113743568, ["Pants"] = 93630306736397},
	["TClothes"] = {["Shirt"] = 0, ["Pants"] = 0},
	["Clothing"] = {"Roblox Breasts Clothing","Roblox Shirt","Roblox Butt Shirt","Roblox Pants","Pussy Closed","Glove"},
	["Preset"] = {Tone = "Use NippleColor", Face = false, BodyPartPhysics = true, PhysicsObeyGravity = true, PositionPhysicsMultiply = 1.4, RotationPhysicsMultiply = 4, BreastsScale = 1.15, ButtsScale = 1.1, LegsScale = 1.06, BreastsType = 1, TorsoType = 3, ArmType = 2, LegsType = 3, ButtType = 3, HardcoreHP = true, TopHP = 50, BottomHP = 50, DamageSFX = 0.1, Volume = 100.2},
...
["Artful"] = {
	...
	["Accessory"] = {12471944802,79627815338226,99455594121581,107017043813707,105949245731969,134817825367110,16569744835,95025858661250,137373731796664},
	["Clothes"] = {["Shirt"] = 73170957816729, ["Pants"] = 126203651493856},
	["TClothes"] = {["Shirt"] = 0, ["Pants"] = 0},
	["Clothing"] = {"Roblox Breasts Clothing","Roblox Shirt","Roblox Butt Shirt","Roblox Pants","Pussy Closed","Glove 2"},
	["Preset"] = {Tone = "Use NippleColor", Face = false, BodyPartPhysics = true, PhysicsObeyGravity = true, PositionPhysicsMultiply = 1, RotationPhysicsMultiply = 5, BreastsScale = 1.05, ButtsScale = 1.03, LegsScale = 1.09, BreastsType = 3, TorsoType = 2, ArmType = 1, LegsType = 2, ButtType = 3, HardcoreHP = true, TopHP = 50, BottomHP = 50, DamageSFX = 0.1, Volume = 100.2},
...
["Grimoire"] = {
	...
	["Accessory"] = {103068493193313,18276572237,140483245207161,122723184354703,136728394009169,131216123676669,16569744835,130346723197335,119819263981388,129800053802762,126051636826222,94063482693334,108308709967658,12983893292},
	["Clothes"] = {["Shirt"] = 125285927098988, ["Pants"] = 76134151763158},
	["TClothes"] = {["Shirt"] = 0, ["Pants"] = 0},
	["Clothing"] = {"Roblox Breasts Clothing","Roblox Shirt","Roblox Butt Shirt","Roblox Pants","Pussy Closed"},
	["Preset"] = {Tone = "Dark", Face = false, BodyPartPhysics = true, PhysicsObeyGravity = true, PositionPhysicsMultiply = 1, RotationPhysicsMultiply = 5, BreastsScale = 1, ButtsScale = 1, LegsScale = 1, BreastsType = 1, TorsoType = 7, ArmType = 1, LegsType = 1, ButtType = 1, HardcoreHP = true, TopHP = 50, BottomHP = 50, DamageSFX = 0.1, Volume = 100.2}
},
...
["Arry"] = {
	...
	["Accessory"] = {116918306368653,88118574638792,17637705854,6984544578,89069963671059,14124914688,15196349731,12297417571,107017043813707,107632831535166},
	["Clothes"] = {["Shirt"] = 16112814126, ["Pants"] = 6808479449},
	["TClothes"] = {["Shirt"] = 11701895124, ["Pants"] = 6808479449},
	["Clothing"] = {"Pussy Closed","Nipple Piercing 20","Roblox Shirt","Roblox Pants","Roblox Breasts Clothing","Roblox Butt Shirt"},
	["Preset"] = {Tone = "Use NippleColor", Face = false, BodyPartPhysics = true, PhysicsObeyGravity = true, PositionPhysicsMultiply = 1, RotationPhysicsMultiply = 5, BreastsScale = 1.1, ButtsScale = 1.1, LegsScale = 1, BreastsType = 1, TorsoType = 8, ArmType = 1, LegsType = 3, ButtType = 1, HardcoreHP = false, TopHP = 50, BottomHP = 50, DamageSFX = 0.1, Volume = 100.2},
...
["Arry (Techwear)"] = {
	...
	["Accessory"] = {116918306368653,88118574638792,17637705854,6984544578,103498846021617,14124914688,15196349731,12297417571,107017043813707,15196349731,14079855932,14618171370},
	["Clothes"] = {["Shirt"] = 87958714738540, ["Pants"] = 6808479449},
	["TClothes"] = {["Shirt"] = 11701895124, ["Pants"] = 6808479449},
	["Clothing"] = {"Pussy Closed","Nipple Piercing 20","Roblox Shirt","Roblox Pants","Roblox Breasts Clothing","Roblox Butt Shirt","Birdly Sleeves"},
	["Preset"] = {Tone = "Use NippleColor", Face = false, BodyPartPhysics = true, PhysicsObeyGravity = true, PositionPhysicsMultiply = 1, RotationPhysicsMultiply = 5, BreastsScale = 1.1, ButtsScale = 1.1, LegsScale = 1, BreastsType = 1, TorsoType = 8, ArmType = 1, LegsType = 3, ButtType = 1, HardcoreHP = false, TopHP = 50, BottomHP = 50, DamageSFX = 0.1, Volume = 100.2},
	["NippleColor"] = Color3.fromRGB(187, 119, 119)
},
...
["Demon (red/nun)"] = {
	...
	["Accessory"] = {13804049078,113689970157202,126912293315942,11466860570,14848399911,13947609337,13947601455,14082636421,18745782340,125267089916125,76160434753712,17734383500,17877621466},
	["Clothes"] = {["Shirt"] = 13840197985, ["Pants"] = 18438952551},
	["Clothing"] = {"Roblox Shirt","Roblox Pants","Roblox Breasts Clothing","Roblox Butt Shirt"},
	["Preset"] = {Tone = "Dark", Face = false, AccessorySizeLock = true, BodyPartPhysics = true, PhysicsObeyGravity = true, RealtimeBodyTransparency = false, PositionPhysicsMultiply = 10, RotationPhysicsMultiply = 15, BreastsScale = 1.3, ButtsScale = 1.2, LegsScale = 1.1, BreastsType = 1, TorsoType = 3, ArmType = 2, LegsType = 3, ButtType = 3}
},
...
["Skittle TBB"] = {
	...
	["Accessory"] = {89446144622093,12700082203,18195300623,89060437197936,132656554742425,9242287193,9242392606,9242239061,92753381669634,16785647211,81008972215317,137648087209240,99994117609298},
	["Clothes"] = {["Shirt"] = 10569889867, ["Pants"] = 214279136},
	["TClothes"] = {["Shirt"] = 0, ["Pants"] = 0},
	["Clothing"] = {"Roblox Breasts Clothing","Roblox Shirt","Roblox Butt Shirt","Roblox Pants","Oiled","Pussy Closed"},
	["Preset"] = {Tone = "Use NippleColor", Face = false, BodyPartPhysics = true, PhysicsObeyGravity = true, PositionPhysicsMultiply = 1, RotationPhysicsMultiply = 5, BreastsScale = 1.01, ButtsScale = 1, LegsScale = 1, BreastsType = 1, TorsoType = 1, ArmType = 1, LegsType = 1, ButtType = 1, HardcoreHP = false, TopHP = 50, BottomHP = 50, DamageSFX = 0.1, Volume = 100.2},
...
["Martyr TBB"] = {
	...
	["Accessory"] = {13196590211,84680959127600,99006189159658,915265974,9185359710,114813132263944,13458529673,140004514942071,123380806313056,13556222058},
	["Clothes"] = {["Shirt"] = 100116841780119, ["Pants"] = 219861893},
	["TClothes"] = {["Shirt"] = 96149389069882, ["Pants"] = 0},
	["Clothing"] = {"Roblox Breasts Clothing","Roblox Shirt","Roblox Butt Shirt","Roblox Pants","Nipple Piercing 1","Pussy Closed"},
	["Preset"] = {Tone = "Use NippleColor", Face = false, BodyPartPhysics = true, PhysicsObeyGravity = true, PositionPhysicsMultiply = 1, RotationPhysicsMultiply = 5, BreastsScale = 1.057, ButtsScale = 1, LegsScale = 1, BreastsType = 1, TorsoType = 1, ArmType = 1, LegsType = 1, ButtType = 3, HardcoreHP = true, TopHP = 50, BottomHP = 50, DamageSFX = 0.1, Volume = 100.2},
...
["Iota TBB"] = {
	...
	["Accessory"] = {15083910799,18771748150,104185335505657,13262492884,212961774,16260807599,84845288490278,100668841966239,8153281046,122232137026453,112347429984327,96583783903610},
	["Clothes"] = {["Shirt"] = 767552806, ["Pants"] = 314623575},
	["TClothes"] = {["Shirt"] = 767552806, ["Pants"] = 0},
	["Clothing"] = {"Roblox Breasts Clothing","Roblox Shirt","Roblox Butt Shirt","Roblox Pants","Pussy Closed"},
	["Preset"] = {Tone = "Dark", Face = false, BodyPartPhysics = true, PhysicsObeyGravity = true, PositionPhysicsMultiply = 1, RotationPhysicsMultiply = 5, BreastsScale = 1.057, ButtsScale = 0.9, LegsScale = 1, BreastsType = 1, TorsoType = 7, ArmType = 1, LegsType = 1, ButtType = 3, HardcoreHP = true, TopHP = 50, BottomHP = 50, DamageSFX = 0.1, Volume = 100.2}
},
...
["Ivory TBB"] = {
	...
	["Accessory"] = {15083910799,76559120450687,105141783679840,13001168964,14728894164,14728896698,16707579677,12848396996,135889208962150,18228496172},
	["Clothes"] = {["Shirt"] = 12906548651, ["Pants"] = 11827229931},
	["TClothes"] = {["Shirt"] = 880341607, ["Pants"] = 0},
	["Clothing"] = {"Roblox Breasts Clothing","Roblox Shirt","Roblox Butt Shirt","Roblox Pants","Pussy Closed"},
	["Preset"] = {Tone = "Dark", Face = false, BodyPartPhysics = true, PhysicsObeyGravity = true, PositionPhysicsMultiply = 1, RotationPhysicsMultiply = 5, BreastsScale = 1.057, ButtsScale = 0.9, LegsScale = 1, BreastsType = 1, TorsoType = 7, ArmType = 1, LegsType = 1, ButtType = 3, HardcoreHP = true, TopHP = 50, BottomHP = 50, DamageSFX = 0.1, Volume = 100.2}
},
		-- Clothing Bundles --
